  ...
  <Layout>
    ...
    <section className="container md:w-9/12 lg:w-8/12">
      ...
      <div className="py-8 md:flex">
        ...
        <div className="w-full md:flex md:px-8 md:w-7/12 lg:w-1/2 lg:px-8">
      ...
      <div className="py-8 md:flex">
        ...
        <div className="w-full md:flex md:align-middle md:justify-center md:max-w-full md:px-8 md:w-7/12 lg:w-1/2 lg:px-8">
          <div className="bg-primary-300">
            <h2>What makes us special</h2>
            <p>These are just some things that make our services unique</p>
            <ul >
        ...
        <div className="w-full md:w-5/12 lg:w-1/2">
          <HalfImage filename="hairdryer" alt="Hairdryer Image" />
        </div>
      </div>
